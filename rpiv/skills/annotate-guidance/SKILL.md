...
10. **Handle Follow-ups:**
    ...
    - **When to re-invoke instead.** Re-run `/rpiv:annotate-guidance` for project-wide refresh after major architectural changes; for single-folder updates, prefer in-place edits.
