...
Browser-based visual companion for the discover interview — showing mockups, diagrams, and options just-in-time when a question is clearer shown than told. (Working files live under `.superpowers/brainstorm/`, a gitignored scratch dir; add `.superpowers/` to `.gitignore`.)
