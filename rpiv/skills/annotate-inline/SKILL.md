...
10. **Handle Follow-ups:**
    ...
    - **When to re-invoke instead.** Re-run `/rpiv:annotate-inline` for project-wide refresh after major architectural changes; for single-folder updates, prefer in-place edits.
